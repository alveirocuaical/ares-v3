...
* [ajustes necesarios de dominio](https://git.buho.la/facturalatam/co-facturadorpro3/-/snippets/44#dominio) <br>
* [pasos para ejecución de script](https://git.buho.la/facturalatam/co-facturadorpro3/-/snippets/44#pasos) <br>
...
[ver pasos y script](https://git.buho.la/facturalatam/co-facturadorpro3/-/snippets/43 "ver")
