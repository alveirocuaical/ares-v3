<template>
    <div class="card mb-0 pt-2 pt-md-0">
                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <h3 class="text-right" v-if="form.total > 0"><b>TOTAL A PAGAR: </b>{{ ratePrefix() }} {{ form.total | numberFormat }}</h3>
                            </div>
                        </div>
                    </div>
        ...
        <quotation-options :showDialog.sync="showDialogOptions" :recordId="quotationNewId" :typeUser="typeUser"
            :showGenerate="false" :showClose="false"></quotation-options>
