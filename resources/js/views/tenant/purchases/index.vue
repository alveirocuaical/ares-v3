...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handlePrintPurchaseLabels({ width, height, pageWidth, columns, gapX, fields, codeType, useEstablishmentName, fontFamily, fontSize }) {
                ...
                const params = new URLSearchParams({
                    ...
                    repeat,
                    codeType,
                    use_establishment: useEstablishmentName,
                    fontFamily,
                    fontSize,
                    ...fields,
                }).toString();
