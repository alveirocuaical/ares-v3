...
Vue.component('tenant-seller-index', require('@viewsModuleProColombia/tenant/seller/index.vue'));
...
//report seller
Vue.component('tenant-report-sellers-index', require('../../modules/Report/Resources/assets/js/views/sellers/index.vue'));
...
Vue.component('tenant-accounting-bank-reconciliation-index', require('@viewsModuleAccounting/bank_reconciliation/index.vue'));
...
Vue.component('tenant-accounting-reports-trial-balance-index', require('@viewsModuleAccounting/reports/trial_balance.vue'));
Vue.component('tenant-accounting-reports-general-ledger-index', require('@viewsModuleAccounting/reports/general-ledger.vue'));
