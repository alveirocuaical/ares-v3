<template>
    <div class="card mb-0 pt-2 pt-md-0 card-config">
        ...
        <div class="card-body">
            <div>
                ...
                <el-table :data="records" style="width: 100%">
                    <el-table-column prop="name" label="Tipo Doc." width="180">
                    </el-table-column>
                    <el-table-column prop="prefix" label="Prefijo" width="120">
                    </el-table-column>
                    <el-table-column prop="resolution_number" label="Número">
                    </el-table-column>
                    <el-table-column prop="resolution_date" label="Fecha Desde">
                    </el-table-column>
                    <el-table-column prop="resolution_date_end" label="Fecha Hasta">
                    </el-table-column>
                    <el-table-column prop="from" label="Desde">
                    </el-table-column>
                    <el-table-column prop="to" label="Hasta">
                    </el-table-column>
                    <el-table-column prop="description" label="Descripcion">
                    </el-table-column>
                    <el-table-column fixed="right" label="Seleccionar" width="100">
                        <template slot-scope="scope">
                            <el-button icon="el-icon-check" @click.native.prevent="selection(scope.row)" size="mini">
                            </el-button>
                            <!--                            <el-button
                            type="danger"
                            plain
                ...
                <form autocomplete="off">
                    <div class="form-body">
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.type_document_id }">
                                    ...
                                    <el-select @change="changeTypeDocument" v-model="resolution.type_document_id"
                                        filterable remote class="border-left rounded-left border-info"
                                        popper-class="el-select-type-document"
                                        placeholder="Seleccione el tipo de documento."
                                        :disabled="disableIndexFieldsResolution">
                                        <el-option v-for="option in typeDocuments" :key="option.id" :value="option.id"
                                            :label="option.name">
                                        </el-option>
                                    </el-select>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.prefix }">
                                    ...
                                    <el-input v-model="resolution.prefix"
                                        placeholder="Digite el prefijo de la resolucion" maxlength="4"
                                        :disabled="disableIndexFieldsResolution">
                                    </el-input>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.resolution }">
                                    ...
                                    <el-input v-model="resolution.resolution"
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.resolution_date }">
                                    ...
                                    <el-date-picker v-model="resolution.resolution_date" type="date"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.date_from }">
                                    ...
                                    <el-date-picker v-model="resolution.date_from" type="date" value-format="yyyy-MM-dd"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.date_to }">
                                    ...
                                    <el-date-picker v-model="resolution.date_to" type="date" value-format="yyyy-MM-dd"
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.from }">
                                    ...
                                    <el-input v-model="resolution.from"
                                        placeholder="Introduzca el numero inicial de la resolucion." :disabled="false">
                                    </el-input>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.to }">
                                    ...
                                    <el-input v-model="resolution.to"
                                        placeholder="Digite el numero final de la resolucion." :disabled="false">
                                    </el-input>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.technical_key }">
                                    ...
                                    <el-input v-model="resolution.technical_key"
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="form-group" :class="{ 'has-danger': errors.description }">
                                    ...
                                    <el-input v-model="resolution.description"
                                        placeholder="Cadena descriptiva de la resolucion." :disabled="false">
                                    </el-input>
                        ...
                        <div class="form-actions text-right mt-4">
                            ...
                            <el-button type="primary" :loading="loadingResolution"
...
export default {
    ...
    methods: {
        ...
        validateResolution(scope, model = null, models = null, modelObject = null) {
            // Limpiar errores previos del prefijo
            if (this.errors.prefix) {
                delete this.errors.prefix;
            }

            // Validación SOLO del prefijo
            if (!this.resolution.prefix || this.resolution.prefix.trim() === '') {
                this.$set(this.errors, 'prefix', ['El prefijo es obligatorio']);
                this.$message.error('El prefijo es obligatorio');
                return;
            }

            // Si llegamos aquí, el prefijo es válido
