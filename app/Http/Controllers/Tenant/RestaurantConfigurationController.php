...
use App\Models\Tenant\RestaurantConfiguration;
use App\Models\Tenant\RestaurantRole;
use App\Models\Tenant\RestaurantTable;
use App\Models\Tenant\RestaurantTableEnv;
...
use App\Models\Tenant\RestaurantItemOrderStatus;
use Carbon\Carbon;
...
class RestaurantConfigurationController extends Controller
{
    ...
    {
        return view('tenant.restaurant_configuration.index');
    }
    ...
    public function record()
    {
        ...
        $companyservice = CompanyService::firstOrFail();
        ...
        return [
            ...
            'info' => ['NIT' => $company->identification_number, 'userEmail' => $user->email, 'socketServer' => config('tenant.socket_server') ?? 'http://localhost:8070'],
        ];
    }
    ...
    {
        $users = User::where('restaurant_role_id','<>',null)
